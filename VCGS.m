...
[saliencyMap1] = VSca(labRef,sigmaF,omega0);
[saliencyMap2] = VSca(labDis,sigmaF,omega0);
...
VSSimMatrix = (2 * saliencyMap1 .* saliencyMap2 + Kvc) ./ (saliencyMap1.^2 + saliencyMap2.^2 + Kvc);
...
return;
%===================================
function [VSMap] = VSca(labimage,sigmaF,omega0)
% ========================================================================
%
